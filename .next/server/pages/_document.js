...
// CONCATENATED MODULE: ./src/components/digitalAnalytics/DigitalAnalytics.tsx
var __jsx = external_react_default.a.createElement;

/* harmony default export */ var DigitalAnalytics = (props => {
  const {
    useAmp,
    gaId,
    gtmId,
...
const DigitalAnalyticsAmp = ({
  ampGtmId,
  useAmp
}) => {
  if (useAmp() && ampGtmId) {
    return __jsx("amp-analytics", {
...
const {
  parsed: {
    DIGITAL_ANALYTCS_OPTIMIZE,
    DIGITAL_ANALYTCS_GA,
    DIGITAL_ANALYTCS_GTM,
    DIGITAL_ANALYTCS_AMP_GTM
  }
} = publicRuntimeConfig;

class _document_CustomDocument extends document_default.a {
  static async getInitialProps(ctx) {
    ...
    try {
      ctx.renderPage = () => originalRenderPage({
        enhanceApp: App => props => sheet.collectStyles(_document_jsx(App, props))
      });

      const initialProps = await document_default.a.getInitialProps(ctx);
      return _objectSpread(_objectSpread({}, initialProps), {}, {
        styles: _document_jsx(external_react_default.a.Fragment, null, initialProps.styles, sheet.getStyleElement())
      });
    } finally {
      sheet.seal();
    }
...
/* harmony default export */ var _document = __webpack_exports__["default"] = (_document_CustomDocument);
